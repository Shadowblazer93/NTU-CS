...
stk = Stack()
tstk = Stack()
stk.push(4),stk.push(1),stk.push(6),stk.push(2),stk.push(3),stk.push(5)

while not stk.isEmpty():
    temp = stk.pop()
    while (not tstk.isEmpty() and tstk.peek()>temp):stk.push(tstk.pop())
    tstk.push(temp)

for i in range(tstk.getSize()): stk.push(tstk.pop())
stk.printStack()